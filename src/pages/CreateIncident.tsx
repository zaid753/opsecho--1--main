...
export default function CreateIncident() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-zinc-900/30 border border-white/5 p-10 rounded-3xl backdrop-blur-xl">
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            ...
            <p className="text-zinc-400 text-sm">Initialize a new mission control room and notify responders.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4">
            <label className="text-sm font-medium text-zinc-400">Incident Severity</label>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-400 ml-1">Incident Title</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black border border-white/10 rounded-2xl py-4 pl-12 pr-4 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-400 ml-1">Affected Service</label>
              <div className="relative">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-400 ml-1">Environment</label>
              <div className="relative">
                <Globe className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-zinc-600" />
                <select
                  value={formData.environment}
                  onChange={(e) => setFormData({ ...formData, environment: e.target.value })}
                  className="w-full bg-black border border-white/10 rounded-2xl py-4 pl-12 pr-4 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none appearance-none cursor-pointer"
                >
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-400 ml-1">Incident Description</label>
            <textarea
              required
              rows={4}
              value={formData.description}
              onChange={(e) => setFormData({ ...formData, description: e.target.value })}
              className="w-full bg-black border border-white/10 rounded-2xl p-4 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none resize-none"
